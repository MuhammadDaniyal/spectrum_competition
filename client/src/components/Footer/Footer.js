        ...
        <div className="container-fluid footer">
                <div className="row  justify-content-evenly text-white pt-4 pb-5">
                    <div className="col-lg-3 col-mg-3 col-10 pt-4 mt-3">
                        ...
                        <p style={{ fontSize: "1.5rem", fontWeight: "600" }}>We are a Community of Car Rental hoping to make every individual life easy & better</p>
                        <p className="pera-top"
                            style={{ fontSize: "1.4rem", fontWeight: "300", textAlign: "justify" }}>A community of like-minded individuals who share a passion for betterment. We believe that learning is a lifelong process, and that's why we encourage our members to explore new ideas and technologies.
                        </p>
                        <div className="justify-content-center align-items-center d-flex">
                            <button type="button" className=" my-btn-F btn  px-4"
                                style={{ borderRadius: "30px" }}>BOOK NOW</button>
                        </div>
                        {/* <h1 style={{fontSize: "60px"}}>WHAT ARE YOU  WAITING FOR ?</h1> */}
                    </div>
                    <div className=" secondCol col-lg-3 col-mg-3 col-10 pt-4 mt-3">
                        ...
                        <h3 className="footer-h3 justify-content-center align-items-center d-flex py-3 pt-5">SUPPORT US</h3>
                        <div className="justify-content-center align-items-center d-flex"
                    ...
                    <div className="col-lg-3 col-mg-3 col-10 pt-4 mt-3">
                        ...
                        <div className='thirdCol-inner-div'>
                            ...
                            <i className="bi bi-envelope pe-2"></i> rentry@gmail.com<br />
                           
                            <i className="bi bi-geo-alt pe-2"></i> Block-7, Gulshan e Iqbal 115, Karachi, Pakistan.
